...
`-- B@0.0.2
  ...
  &quot;postshrinkwrap&quot;: &quot;json -I -e \&quot;this.myMetadata = $MY_APP_METADATA\&quot;&quot;
    ...
    <p>Occasionally, two separate npm install will create package locks that cause
        merge conflicts in source control systems. As of <a href="mailto:%60npm@5.7.0">`npm@5.7.0</a><code>, these
            conflicts
            ...
            the dependencies from both branches in a reasonable tree. If</code>--package-lock-only<code>is provided, it
            will do this without also modifying your
    ...
    <p>To make this process seamless on git, consider installing
        ...
        <a href="mailto:pre-%60npm@5.7.0">pre-`npm@5.7.0</a><code>versions of npm 5, albeit a bit more noisily. Note
            that if</code>package.json<code>itself conflicts, you will have to resolve that by hand and run</code>npm
        install` manually, even with the merge driver.</p>
