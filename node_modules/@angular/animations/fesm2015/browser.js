...
/** @type {?} */
let _contains = (elm1, elm2) =
>
false;
/** @type {?} */
let _matches = (element, selector) =
>
false;
/** @type {?} */
...
function dashCaseToCamelCase(input) {
    return input.replace(DASH_CASE_REGEXP, (...m) =
>
    m[1].toUpperCase()
)
    ;
...
class AnimationAstBuilderVisitor {
        ...
        if (styleAst.containsDynamicStyles) {
        ...
        )
            {
                ...
                Object.keys(stylesObj).forEach(prop = > {
                    extractStyleParams(stylesObj[prop]
            ).
                forEach(sub = > {
                    if(
                !params.hasOwnProperty(sub)
            )
                {
                    missingSubs.add(sub);
                }
    ...
    _validateStyleAst(ast, context) {
        ...
        Object.keys(tuple).forEach(prop = > {
            if(
        !this._driver.validateStyleProperty(prop)
    )
        {
    ...
    updateOptions(options, skipIfExists) {
        ...
        if (newParams) {
            ...
            Object.keys(newParams).forEach(name = > {
                if(
            !skipIfExists || !paramsToUpdate.hasOwnProperty(name)
        )
            {
...
class AnimationTransitionNamespace {
    ...
    elementContainsData(element) {
        ...
        if (this._elementListeners.has(element))
            containsData = true;
        containsData =
            (this._queue.find(entry = > entry.element === element) ? true : false
    ) ||
        containsData;
        return containsData;
    }
...
export {
    ...
    AnimationDriver as ɵAnimationDriver,
    NoopAnimationDriver as ɵNoopAnimationDriver,
    AnimationEngine as ɵAnimationEngine,
    CssKeyframesDriver as ɵCssKeyframesDriver,
    CssKeyframesPlayer as ɵCssKeyframesPlayer,
