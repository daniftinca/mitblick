...
}(this, (function (exports, collections, rxjs, operators, core, bidi, coercion, a11y, common) {
    'use strict';
                ...
                if (Array.isArray(childrenNodes)) {
                    ...
                    childrenNodes.pipe(operators.takeUntil(this._destroyed))
                        .subscribe(function (children) {
                            return _this._setRoleFromChildren(children);
                        });
                }
            }
        };
            ...
            if (Array.isArray(childrenNodes)) {
                ...
                childrenNodes.pipe(operators.takeUntil(this._destroyed))
                    .subscribe(function (result) {
                        return _this.updateChildrenNodes(result);
                    });
            }
