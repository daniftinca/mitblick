...
}(this, (function (exports, coercion, core, collections, common, rxjs, operators, bidi, platform) {
    'use strict';
...
// Boilerplate for applying mixins to CdkFooterRowDef.
    ...
    var CdkTable = /** @class */ (function () {
        ...
        function () {
            /** @type {?} */
            var columnsDiffReducer = function (acc, def) {
        ...
        function (rows, rowDef) {
            ...
            var columnDefs = Array.from(rowDef.columns || []).map(function (c) {
                return (/** @type {?} */ (_this._columnDefsByName.get(c)));
            });
            /** @type {?} */
