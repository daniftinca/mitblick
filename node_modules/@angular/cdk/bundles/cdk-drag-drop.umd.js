...
}(this, (function (exports, core, common, platform, rxjs, coercion, bidi, scrolling, operators) {
    'use strict';
...
// classes that are registering themselves will introduce a circular import.
    var DragDropRegistry = /** @class */ (function () {
        ...
        function (drag, event) {
            ...
            if (this._activeDragInstances.size === 1) {
                ...
                this._globalListeners
                    .set(moveEvent, {
                        handler: function (e) {
                            return _this.pointerMove.next((/** @type {?} */ (e)));
                        },
                        options: activeCapturingEventOptions
                    })
                    .set(upEvent, {
                        handler: function (e) {
                            return _this.pointerUp.next((/** @type {?} */ (e)));
                        },
                        options: true
                    })
        ...
        function () {
            ...
            this._dragInstances.forEach(function (instance) {
                return _this.removeDragItem(instance);
            });
            this._dropInstances.forEach(function (instance) {
                return _this.removeDropContainer(instance);
            });
            this._clearGlobalListeners();
        ...
        /** @nocollapse */ DragDropRegistry.ngInjectableDef = core.defineInjectable({
            factory: function DragDropRegistry_Factory() {
                return new DragDropRegistry(core.inject(core.NgZone), core.inject(common.DOCUMENT));
            }, token: DragDropRegistry, providedIn: "root"
        });
    ...
    DragRef = /** @class */ (function () {
        function DragRef(element, _document, _ngZone, _viewContainerRef, _viewportRuler, _dragDropRegistry, _config, dropContainer, _dir) {
            ...
            this._pointerUp = function (event) {
                ...
                if (!_this.dropContainer) {
                    ...
                    _this._ngZone.run(function () {
                        return _this.ended.next({source: _this});
                    });
                    _this._dragDropRegistry.stopDragging(_this);
                    return;
                }
        ...
        function (handles) {
            ...
            handles.forEach(function (handle) {
                return toggleNativeDragInteractions(handle.element.nativeElement, false);
            });
    ...
    var CdkDrag = /** @class */ (function () {
        function CdkDrag(element, dropContainer, _document, _ngZone, _viewContainerRef, _viewportRuler, _dragDropRegistry, _config, _dir) {
            ...
            this.moved = rxjs.Observable.create(function (observer) {
                /** @type {?} */
                var subscription = _this._dragRef.moved.pipe(operators.map(function (movedEvent) {
                    return ({
                        source: _this,
                ...
                .subscribe(function () {
                    ...
                    _this._handles.changes
                        ...
                        .subscribe(function (handleList) {
                            _this._dragRef.withHandles(handleList.filter(function (handle) {
                                return handle._parentDrag === _this;
                            }));
                        });
                });
        };
    ...
    DropListRef = /** @class */ (function () {
        ...
        function () {
            ...
            this._positionCache.siblings.forEach(function (sibling) {
                return sibling.drop._toggleIsReceiving(true);
            });
        };
        /**
        ...
        function () {
            ...
            this._positionCache.siblings = this._siblings.map(function (drop) {
                return ({
                    drop: drop,
        ...
        function () {
            ...
            this._positionCache.siblings.forEach(function (sibling) {
                return sibling.drop._toggleIsReceiving(false);
            });
        ...
        function (pointerX, pointerY) {
            var _a = this._positionCache.self, top = _a.top, right = _a.right, bottom = _a.bottom, left = _a.left,
...
// be removed when `CdkDropListContainer` is deleted.
    ...
    var CdkDropList = /** @class */ (function () {
            ...
            ref.beforeStarted.subscribe(function () {
                ...
                var siblings = coercion.coerceArray(_this.connectedTo).map(function (drop) {
                    return typeof drop === 'string' ?
                        (/** @type {?} */ (CdkDropList._dropLists.find(function (list) {
                            return list.id === drop;
                        }))) : drop;
                });
                if (_this._group) {
                ...
                ref.lockAxis = _this.lockAxis;
                ref
                    .connectedTo(siblings.filter(function (drop) {
                        return drop && drop !== _this;
                    }).map(function (list) {
                        return list._dropListRef;
                    }))
                    .withOrientation(_this.orientation)
                    .withItems(_this._draggables.map(function (drag) {
        ...
        CdkDropList.propDecorators = {
            _draggables: [{
                type: core.ContentChildren, args: [core.forwardRef(function () {
                    return CdkDrag;
                }),]
            }],
