...
}(this, (function (exports, coercion, scrolling, common, core, rxjs, operators, platform, bidi, portal, keycodes) {
    'use strict';
...
// TODO(jelbourn): someday replace this with IntersectionObservers
    ...
    var ScrollStrategyOptions = /** @class */ (function () {
        ...
        /** @nocollapse */ ScrollStrategyOptions.ngInjectableDef = core.defineInjectable({
            factory: function ScrollStrategyOptions_Factory() {
                return new ScrollStrategyOptions(core.inject(scrolling.ScrollDispatcher), core.inject(scrolling.ViewportRuler), core.inject(core.NgZone), core.inject(common.DOCUMENT));
            }, token: ScrollStrategyOptions, providedIn: "root"
        });
    ...
    var OverlayKeyboardDispatcher = /** @class */ (function () {
        ...
        /** @nocollapse */ OverlayKeyboardDispatcher.ngInjectableDef = core.defineInjectable({
            factory: function OverlayKeyboardDispatcher_Factory() {
                return new OverlayKeyboardDispatcher(core.inject(common.DOCUMENT));
    ...
    var OverlayContainer = /** @class */ (function () {
        ...
        /** @nocollapse */ OverlayContainer.ngInjectableDef = core.defineInjectable({
            factory: function OverlayContainer_Factory() {
                return new OverlayContainer(core.inject(common.DOCUMENT));
...
// TODO: doesn't handle both flexible width and height when it has to scroll along both axis.
    ...
    var OverlayPositionBuilder = /** @class */ (function () {
        ...
        /** @nocollapse */ OverlayPositionBuilder.ngInjectableDef = core.defineInjectable({
            factory: function OverlayPositionBuilder_Factory() {
                return new OverlayPositionBuilder(core.inject(scrolling.ViewportRuler), core.inject(common.DOCUMENT), core.inject(platform.Platform, 8), core.inject(OverlayContainer, 8));
...
// it needs is different based on where OverlayModule is imported.
    ...
    var FullscreenOverlayContainer = /** @class */ (function (_super) {
        ...
        /** @nocollapse */ FullscreenOverlayContainer.ngInjectableDef = core.defineInjectable({
            factory: function FullscreenOverlayContainer_Factory() {
                return new FullscreenOverlayContainer(core.inject(common.DOCUMENT));
