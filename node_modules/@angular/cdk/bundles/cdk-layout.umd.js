...
(function (global, factory) {
...
}(this, (function (exports, core, platform, rxjs, operators, coercion) {
    'use strict';
    ...
    var MediaMatcher = /** @class */ (function () {
        ...
        /** @nocollapse */ MediaMatcher.ngInjectableDef = core.defineInjectable({
            factory: function MediaMatcher_Factory() {
                return new MediaMatcher(core.inject(platform.Platform));
            }, token: MediaMatcher, providedIn: "root"
        });
        return MediaMatcher;
    }());
    ...
    var BreakpointObserver = /** @class */ (function () {
        ...
        function (query) {
            ...
            var queryObservable = rxjs.fromEventPattern(
                ...
                .pipe(operators.startWith(mql), operators.map(function (nextMql) {
        ...
        /** @nocollapse */ BreakpointObserver.ngInjectableDef = core.defineInjectable({
            factory: function BreakpointObserver_Factory() {
                return new BreakpointObserver(core.inject(MediaMatcher), core.inject(core.NgZone));
            }, token: BreakpointObserver, providedIn: "root"
        });
