...
(function (global, factory) {
...
}(this, (function (exports, core, coercion, rxjs, operators, platform, bidi, collections) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var ScrollDispatcher = /** @class */ (function () {
        ...
        function () {
            ...
            this._globalSubscription = this._ngZone.runOutsideAngular(function () {
                return rxjs.fromEvent(window.document, 'scroll').subscribe(function () {
        ...
        /** @nocollapse */ ScrollDispatcher.ngInjectableDef = core.defineInjectable({
            factory: function ScrollDispatcher_Factory() {
                return new ScrollDispatcher(core.inject(core.NgZone), core.inject(platform.Platform));
            }, token: ScrollDispatcher, providedIn: "root"
        });
    ...
    var CdkVirtualScrollViewport = /** @class */ (function (_super) {
        ...
        CdkVirtualScrollViewport.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [VIRTUAL_SCROLL_STRATEGY,]}]
                },
                {type: bidi.Directionality, decorators: [{type: core.Optional}]},
                {type: ScrollDispatcher}
            ];
        ...
        Object.defineProperty(CdkVirtualForOf.prototype, "cdkVirtualForTrackBy", {
            ...
            function (fn) {
                ...
                this._cdkVirtualForTrackBy = fn ?
                    function (index, item) {
                        return fn(index + (_this._renderedRange ? _this._renderedRange.start : 0), item);
                    } :
                    undefined;
            },
            enumerable: true,
    ...
    var ViewportRuler = /** @class */ (function () {
        ...
        /** @nocollapse */ ViewportRuler.ngInjectableDef = core.defineInjectable({
            factory: function ViewportRuler_Factory() {
                return new ViewportRuler(core.inject(platform.Platform), core.inject(core.NgZone));
            }, token: ViewportRuler, providedIn: "root"
        });
