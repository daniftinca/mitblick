...
(function (global, factory) {
...
}(this, (function (exports, platform, core, rxjs, coercion, operators) {
    'use strict';
    ...
    var AutofillMonitor = /** @class */ (function () {
            ...
            var listener = (/** @type {?} */ ((function (event) {
                ...
                if (event.animationName === 'cdk-text-field-autofill-start' &&
                    ...
                    _this._ngZone.run(function () {
                        return result.next({target: (/** @type {?} */ (event.target)), isAutofilled: true});
                    });
                }
                    ...
                    _this._ngZone.run(function () {
                        return result.next({target: (/** @type {?} */ (event.target)), isAutofilled: false});
                    });
                }
            })));
        ...
        /** @nocollapse */ AutofillMonitor.ngInjectableDef = core.defineInjectable({
            factory: function AutofillMonitor_Factory() {
                return new AutofillMonitor(core.inject(platform.Platform), core.inject(core.NgZone));
            ...
            this._ngZone.runOutsideAngular(function () {
                if (typeof requestAnimationFrame !== 'undefined') {
                    requestAnimationFrame(function () {
                        return _this._scrollToCaretPosition(textarea);
                    });
                }
                else {
                    setTimeout(function () {
