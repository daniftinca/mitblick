...
}(this, (function (exports, common, core, rxjs, keycodes, operators, platform, coercion, observers) {
    'use strict';
...
***************************************************************************** */
    ...
    var AriaDescriber = /** @class */ (function () {
        ...
        /** @nocollapse */ AriaDescriber.ngInjectableDef = core.defineInjectable({
            factory: function AriaDescriber_Factory() {
                return new AriaDescriber(core.inject(common.DOCUMENT));
            }, token: AriaDescriber, providedIn: "root"
        });
    ...
    ListKeyManager = /** @class */ (function () {
        ...
        function (debounceInterval) {
            ...
            if ((/** @type {?} */ (this))._items.length && (/** @type {?} */ (this))._items.some(function (item) {
            ...
            (/** @type {?} */ (this))._typeaheadSubscription = (/** @type {?} */ (this))._letterKeyStream.pipe(operators.tap(function (keyCode) {
                return (/** @type {?} */ (_this))._pressedLetters.push(keyCode);
            }), operators.debounceTime(debounceInterval), operators.filter(function () {
                return (/** @type {?} */ (_this))._pressedLetters.length > 0;
            }), operators.map(function () {
                return (/** @type {?} */ (_this))._pressedLetters.join('');
...
// supported.
    ...
    var InteractivityChecker = /** @class */ (function () {
        ...
        /** @nocollapse */ InteractivityChecker.ngInjectableDef = core.defineInjectable({
            factory: function InteractivityChecker_Factory() {
                return new InteractivityChecker(core.inject(platform.Platform));
            }, token: InteractivityChecker, providedIn: "root"
        });
        ...
        function () {
            ...
            this._ngZone.runOutsideAngular(function () {
                ...
                if (!_this._endAnchor) {
                    ...
                    (/** @type {?} */ (_this._endAnchor)).addEventListener('focus', function () {
    ...
    var FocusTrapFactory = /** @class */ (function () {
        ...
        /** @nocollapse */ FocusTrapFactory.ngInjectableDef = core.defineInjectable({
            factory: function FocusTrapFactory_Factory() {
                return new FocusTrapFactory(core.inject(InteractivityChecker), core.inject(core.NgZone), core.inject(common.DOCUMENT));
            }, token: FocusTrapFactory, providedIn: "root"
        });
    ...
    var CdkTrapFocus = /** @class */ (function () {
        ...
        Object.defineProperty(CdkTrapFocus.prototype, "enabled", {
             ...
             */
            function (value) {
                this.focusTrap.enabled = coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(CdkTrapFocus.prototype, "autoCapture", {
             ...
             */
            function (value) {
                this._autoCapture = coercion.coerceBooleanProperty(value);
            },
            enumerable: true,
            configurable: true
        });
    ...
    var LiveAnnouncer = /** @class */ (function () {
        ...
        LiveAnnouncer.ctorParameters = function () {
            return [
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [LIVE_ANNOUNCER_ELEMENT_TOKEN,]}]
                },
                {type: core.NgZone},
                {type: undefined, decorators: [{type: core.Inject, args: [common.DOCUMENT,]}]}
            ];
        };
        /** @nocollapse */ LiveAnnouncer.ngInjectableDef = core.defineInjectable({
            factory: function LiveAnnouncer_Factory() {
                return new LiveAnnouncer(core.inject(LIVE_ANNOUNCER_ELEMENT_TOKEN, 8), core.inject(core.NgZone), core.inject(common.DOCUMENT));
            }, token: LiveAnnouncer, providedIn: "root"
        });
...
// that a value of around 650ms seems appropriate.
    ...
    var FocusMonitor = /** @class */ (function () {
        ...
        /** @nocollapse */ FocusMonitor.ngInjectableDef = core.defineInjectable({
            factory: function FocusMonitor_Factory() {
                return new FocusMonitor(core.inject(core.NgZone), core.inject(platform.Platform));
            }, token: FocusMonitor, providedIn: "root"
        });
        return FocusMonitor;
    }());
    /**
