...
>
    ...
    .
        ...
        const baseTemplateContext = Object.assign({}, core_1.strings, {'if-flat': (s) = > options.flat ? '' : s
    },
        options
    )
        ;
        ...
        const templateSource = schematics_1.apply(schematics_1.url(schematicFilesUrl), [
            ...
            options
    .
        inlineStyle ? schematics_1.filter(path = > !path.endsWith('.__styleext__')
    ) :
        schematics_1.noop(),
            options.inlineTemplate ? schematics_1.filter(path = > !path.endsWith('.html')
    ) :
        schematics_1.noop(),
