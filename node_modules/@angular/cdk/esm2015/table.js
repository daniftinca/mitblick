...
class StickyStyler {
    ...
    updateStickyColumns(rows, stickyStartStates, stickyEndStates) {
        /** @type {?} */
        const hasStickyColumns = stickyStartStates.some(state = > state
    ) ||
...
class CdkTable {
    ...
    updateStickyColumnStyles() {
        ...
        this._stickyStyler.clearStickyPositioning([...headerRows,...dataRows,
    ...
        footerRows
    ],
        ['left', 'right']
    ...
    _getRowDefs(data, dataIndex) {
        ...
        if (this.multiTemplateDataRows) {
            ...
            /** @type {?} */
            let rowDef = this._rowDefs.find(def = > def.when && def.when(dataIndex, data)
        ) ||
            this._defaultRowDef;
            if (rowDef) {
                rowDefs.push(rowDef);
