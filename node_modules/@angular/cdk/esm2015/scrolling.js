...
/** @nocollapse */ ScrollDispatcher.ngInjectableDef = defineInjectable({
...
class CdkVirtualForOf {
    ...
    set cdkVirtualForTrackBy(fn) {
        ...
        this._cdkVirtualForTrackBy = fn ?
            (index, item) =
    >
        fn(index + (this._renderedRange ? this._renderedRange.start : 0), item)
    :
        undefined;
    }
    ...
    _applyChanges(changes) {
        ...
        if (currentIndex == null) { // Item removed.
...
/** @nocollapse */ ViewportRuler.ngInjectableDef = defineInjectable({
