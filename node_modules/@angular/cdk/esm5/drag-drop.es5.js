...
var DragDropRegistry = /** @class */ (function () {
    ...
    /** @nocollapse */ DragDropRegistry.ngInjectableDef = defineInjectable({
...
var CdkDrag = /** @class */ (function () {
    function CdkDrag(element, dropContainer, _document, _ngZone, _viewContainerRef, _viewportRuler, _dragDropRegistry, _config, _dir) {
        ...
        this.moved = Observable.create(function (observer) {
            /** @type {?} */
            var subscription = _this._dragRef.moved.pipe(map(function (movedEvent) {
                return ({
                    source: _this,
...
var CdkDropList = /** @class */ (function () {
    ...
    CdkDropList.propDecorators = {
        _draggables: [{
            type: ContentChildren, args: [forwardRef(function () {
                return CdkDrag;
            }),]
        }],
