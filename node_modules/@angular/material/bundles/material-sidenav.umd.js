...
}(this, (function (exports, animations, a11y, bidi, coercion, keycodes, platform, scrolling, common, core, rxjs, operators, animations$1, core$1) {
    'use strict';
            ...
            return [
                {type: core.ChangeDetectorRef},
                {
                    type: MatDrawerContainer, decorators: [{
                        type: core.Inject, args: [core.forwardRef(function () {
    ...
    var MatDrawer = /** @class */ (function () {
        function MatDrawer(_elementRef, _focusTrapFactory, _focusMonitor, _platform, _ngZone, _doc) {
            ...
            this._ngZone.runOutsideAngular(function () {
                ...
                }), operators.takeUntil(_this._destroyed)).subscribe(function (event) {
        ...
        Object.defineProperty(MatDrawer.prototype, "_openedStream", {
             ...
             */
            function () {
                return this.openedChange.pipe(operators.filter(function (o) {
                    return o;
        ...
        Object.defineProperty(MatDrawer.prototype, "openedStart", {
             ...
             */
            function () {
                return this._animationStarted.pipe(operators.filter(function (e) {
        ...
        function (isOpen, openedVia) {
            ...
            return new Promise(function (resolve) {
                _this.openedChange.pipe(operators.take(1)).subscribe(function (open) {
    ...
    var MatDrawerContainer = /** @class */ (function () {
        ...
        function () {
            ...
            this._doCheckSubject.pipe(operators.debounceTime(10), // Arbitrary debounce time, less than a frame at 60fps
                operators.takeUntil(this._destroyed)).subscribe(function () {
                return _this._updateContentMargins();
            });
        };
        /**
        ...
        function (drawer) {
            var _this = this;
            drawer._animationStarted.pipe(operators.filter(function (event) {
                return event.fromState !== event.toState;
            }), operators.takeUntil(this._drawers.changes))
                .subscribe(function (event) {
    ...
    var MatSidenavContent = /** @class */ (function (_super) {
        ...
        MatSidenavContent.ctorParameters = function () {
            return [
                {type: core.ChangeDetectorRef},
                {
                    type: MatSidenavContainer, decorators: [{
                        type: core.Inject, args: [core.forwardRef(function () {
