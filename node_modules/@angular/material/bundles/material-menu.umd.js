...
}(this, (function (exports, core, portal, common, rxjs, animations, a11y, core$1, coercion, keycodes, operators, bidi, overlay, platform) {
    'use strict';
...
// Boilerplate for applying mixins to MatMenuItem.
    ...
    var MatMenu = /** @class */ (function () {
         ...
         */
        function () {
            return this._itemChanges.pipe(operators.startWith(this._items), operators.switchMap(function (items) {
                return rxjs.merge.apply(void 0, items.map(function (item) {
...
// TODO(andrewseguin): Remove the kebab versions in favor of camelCased attribute selectors
    ...
    var MatMenuTrigger = /** @class */ (function () {
        ...
        function () {
            ...
            /** @type {?} */
            var hover = this._parentMenu ? this._parentMenu._hovered().pipe(operators.filter(function (active) {
        ...
        function () {
            ...
            // it won't be closed immediately after it is opened.
                .pipe(operators.filter(function (active) {
