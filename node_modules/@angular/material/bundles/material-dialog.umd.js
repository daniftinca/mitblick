...
(function (global, factory) {
...
}(this, (function (exports, animations, core, common, portal, a11y, keycodes, rxjs, operators, bidi, overlay, core$1) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var animationBody = [
        ...
        animations.transition('* => enter', animations.animate('150ms cubic-bezier(0, 0, 0.2, 1)', animations.style({
            transform: 'none',
            opacity: 1
        }))),
...
// Counter for unique dialog ids.
    ...
    MatDialogRef = /** @class */ (function () {
        function MatDialogRef(_overlayRef, _containerInstance,
            ...
            _containerInstance._animationStateChanged.pipe(operators.filter(function (event) {
            ...
            _containerInstance._animationStateChanged.pipe(operators.filter(function (event) {
                ...
                return _this._overlayRef.dispose();
            });
            ...
            _overlayRef.keydownEvents()
                .pipe(operators.filter(function (event) {
                    return event.keyCode === keycodes.ESCAPE && !_this.disableClose;
                }))
                .subscribe(function () {
                    return _this.close();
                });
        ...
        function (dialogResult) {
            ...
            this._containerInstance._animationStateChanged.pipe(operators.filter(function (event) {
    ...
    function MAT_DIALOG_SCROLL_STRATEGY_FACTORY(overlay$$1) {
        return function () {
            return overlay$$1.scrollStrategies.block();
        };
    }
    ...
    var MatDialog = /** @class */ (function () {
        ...
        function (componentOrTemplateRef, dialogContainer, overlayRef, config) {
            ...
            if (componentOrTemplateRef instanceof core.TemplateRef) {
                dialogContainer.attachTemplatePortal(new portal.TemplatePortal(componentOrTemplateRef, (/** @type {?} */ (null)), (/** @type {?} */ ({
        ...
        MatDialog.ctorParameters = function () {
            return [
                ...
                {
                    type: MatDialogConfig,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_DIALOG_DEFAULT_OPTIONS,]}]
                },
