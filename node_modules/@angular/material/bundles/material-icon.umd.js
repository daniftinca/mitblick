...
}(this, (function (exports, common, http, core, platformBrowser, rxjs, operators, core$1, coercion) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatIconRegistry = /** @class */ (function () {
        ...
        function (safeUrl) {
            ...
            return this._loadSvgIconFromConfig(new SvgIconConfig(safeUrl)).pipe(operators.tap(function (svg) {
                return _this._cachedIconsByUrl.set((/** @type {?} */ (url)), svg);
            }), operators.map(function (svg) {
                return cloneSvg(svg);
            }));
        };
        /**
        ...
        function (config) {
            if (config.svgElement) {
                ...
                return this._loadSvgIconFromConfig(config).pipe(operators.tap(function (svg) {
        ...
        function (config) {
            ...
            return this._fetchUrl(config.url)
                .pipe(operators.map(function (svgText) {
        ...
        function (safeUrl) {
            ...
            /** @type {?} */
            var req = this._httpClient.get(url, {responseType: 'text'}).pipe(operators.finalize(function () {
        ...
        /** @nocollapse */ MatIconRegistry.ngInjectableDef = core.defineInjectable({
            factory: function MatIconRegistry_Factory() {
                return new MatIconRegistry(core.inject(http.HttpClient, 8), core.inject(platformBrowser.DomSanitizer), core.inject(common.DOCUMENT, 8));
        ...
        function (changes) {
            ...
            if (changes.svgIcon) {
                if (this.svgIcon) {
                    ...
                    this._iconRegistry.getNamedSvgIcon(iconName, namespace).pipe(operators.take(1)).subscribe(function (svg) {
