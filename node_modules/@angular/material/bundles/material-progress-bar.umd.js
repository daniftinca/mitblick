...
}(this, (function (exports, core, rxjs, operators, animations, core$1, common) {
    'use strict';
...
// Boilerplate for applying mixins to MatProgressBar.
     ...
     * @type {?}
     */
    var MAT_PROGRESS_BAR_LOCATION = new core.InjectionToken('mat-progress-bar-location', {
        providedIn: 'root',
    ...
    var MatProgressBar = /** @class */ (function (_super) {
        ...
        MatProgressBar.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_PROGRESS_BAR_LOCATION,]}]
                }
            ];
        };
