...
}(this, (function (exports, core, core$1, coercion, bidi) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatGridTile = /** @class */ (function () {
        ...
        Object.defineProperty(MatGridTile.prototype, "rowspan", {
             ...
             */
            function (value) {
                this._rowspan = Math.round(coercion.coerceNumberProperty(value));
            },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(MatGridTile.prototype, "colspan", {
             ...
             */
            function (value) {
                this._colspan = Math.round(coercion.coerceNumberProperty(value));
            },
            enumerable: true,
            configurable: true
        });
    ...
    var MatGridList = /** @class */ (function () {
        ...
        function () {
            ...
            var tiles = this._tiles.filter(function (tile) {
                return !tile._gridList || tile._gridList === _this;
            });
            /** @type {?} */
