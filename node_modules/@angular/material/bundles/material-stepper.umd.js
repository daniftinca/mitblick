...
(function (global, factory) {
...
}(this, (function (exports, core, stepper, rxjs, a11y, animations, bidi, common, core$1, operators, portal, button, icon) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatStepperIntl = /** @class */ (function () {
        ...
        /** @nocollapse */ MatStepperIntl.ngInjectableDef = core.defineInjectable({
    ...
    var matStepperAnimations = {
        ...
        horizontalStepTransition: animations.trigger('stepTransition', [
            animations.state('previous', animations.style({
    ...
    var MatStep = /** @class */ (function (_super) {
        ...
        MatStep.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [stepper.STEPPER_GLOBAL_OPTIONS,]}]
                }
            ];
        };
    ...
    var MatStepper = /** @class */ (function (_super) {
        ...
        function () {
            ...
            this._animationDone.pipe(
                ...
                operators.distinctUntilChanged(function (x, y) {
                    return x.fromState === y.fromState && x.toState === y.toState;
                }), operators.takeUntil(this._destroyed)).subscribe(function (event) {
