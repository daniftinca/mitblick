...
}(this, (function (exports, core, a11y, coercion, forms, core$1, animations, observers, common) {
    'use strict';
    ...
    var MatCheckbox = /** @class */ (function (_super) {
        ...
        MatCheckbox.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_CHECKBOX_CLICK_ACTION,]}]
                },
                {
                    type: String,
