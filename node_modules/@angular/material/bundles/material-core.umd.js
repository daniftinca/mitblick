...
}(this, (function (exports, core, platformBrowser, bidi, coercion, rxjs, platform, operators, a11y, animations, keycodes, common) {
    'use strict';
    ...
    var MatCommonModule = /** @class */ (function () {
        ...
        MatCommonModule.ctorParameters = function () {
            return [
                {
                    type: Boolean,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MATERIAL_SANITY_CHECKS,]}]
                },
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [platformBrowser.HAMMER_LOADER,]}]
                }
            ];
        };
...
// TODO(mmalerba): Remove when we no longer support safari 9.
    ...
    var ErrorStateMatcher = /** @class */ (function () {
        ...
        /** @nocollapse */ ErrorStateMatcher.ngInjectableDef = core.defineInjectable({
            factory: function ErrorStateMatcher_Factory() {
                return new ErrorStateMatcher();
            }, token: ErrorStateMatcher, providedIn: "root"
        });
    ...
    var GestureConfig = /** @class */ (function (_super) {
        ...
        GestureConfig.ctorParameters = function () {
            return [
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_HAMMER_OPTIONS,]}]
                },
    ...
    var MatRipple = /** @class */ (function () {
        ...
        MatRipple.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_RIPPLE_GLOBAL_OPTIONS,]}]
                },
                {
                    type: String,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [animations.ANIMATION_MODULE_TYPE,]}]
                }
            ];
        };
    ...
    var MatOption = /** @class */ (function () {
        ...
        MatOption.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_OPTION_PARENT_COMPONENT,]}]
                },
