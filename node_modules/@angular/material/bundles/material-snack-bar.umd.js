...
(function (global, factory) {
...
}(this, (function (exports, rxjs, core, animations, portal, operators, overlay, common, core$1, button, a11y, layout) {
    'use strict';
    ...
    ***************************************************************************** */
    ...
    var MatSnackBar = /** @class */ (function () {
        ...
        /** @nocollapse */ MatSnackBar.ngInjectableDef = core.defineInjectable({
            factory: function MatSnackBar_Factory() {
                return new MatSnackBar(core.inject(overlay.Overlay), core.inject(a11y.LiveAnnouncer), core.inject(core.INJECTOR), core.inject(layout.BreakpointObserver), core.inject(MatSnackBar, 12), core.inject(MAT_SNACK_BAR_DEFAULT_OPTIONS));
