...
}(this, (function (exports, coercion, keycodes, platform, core, core$1, rxjs, operators, a11y, bidi, collections, forms, formField) {
    'use strict';
    ...
    var MatChip = /** @class */ (function (_super) {
        ...
        MatChip.ctorParameters = function () {
            return [
                ...
                {
                    type: undefined,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [core$1.MAT_RIPPLE_GLOBAL_OPTIONS,]}]
                }
            ];
        };
        MatChip.propDecorators = {
            ...
            removeIcon: [{
                type: core.ContentChild, args: [core.forwardRef(function () {
...
// Increasing integer for generating unique ids for chip-list components.
    ...
    var MatChipList = /** @class */ (function (_super) {
            ...
            function (value) {
                ...
                if (this.chips) {
                    this.chips.forEach(function (chip) {
                        return chip.disabled = _this._disabled;
                    });
                }
            },
            enumerable: true,
        ...
        Object.defineProperty(MatChipList.prototype, "chipSelectionChanges", {
             ...
             */
            function () {
                return rxjs.merge.apply(void 0, this.chips.map(function (chip) {
            ...
            if (this._dir) {
                this._dir.change
                    ...
                    .subscribe(function (dir) {
                        return _this._keyManager.withHorizontalOrientation(dir);
                    });
            }
