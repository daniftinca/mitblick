...
}(this, (function (exports, core, animations, core$1, portal, layout, common, a11y, overlay, keycodes, rxjs, operators, bidi) {
    'use strict';
...
// TODO(crisbeto): consolidate some logic between this, MatDialog and MatSnackBar
    ...
    MatBottomSheetRef = /** @class */ (function () {
        function MatBottomSheetRef(containerInstance, _overlayRef,
            ...
            containerInstance._animationStateChanged.pipe(operators.filter(function (event) {
            ...
            if (!containerInstance.bottomSheetConfig.disableClose) {
                rxjs.merge(_overlayRef.backdropClick(), _overlayRef.keydownEvents().pipe(operators.filter(function (event) {
        ...
        function (result) {
            ...
            if (!this._afterDismissed.closed) {
                ...
                this.containerInstance._animationStateChanged.pipe(operators.filter(function (event) {
                    return event.phaseName === 'start';
                }), operators.take(1)).subscribe(function () {
    ...
    var MatBottomSheet = /** @class */ (function () {
        ...
        MatBottomSheet.ctorParameters = function () {
            return [
                ...
                {
                    type: MatBottomSheetConfig,
                    decorators: [{type: core.Optional}, {type: core.Inject, args: [MAT_BOTTOM_SHEET_DEFAULT_OPTIONS,]}]
                }
            ];
        };
        /** @nocollapse */ MatBottomSheet.ngInjectableDef = core.defineInjectable({
            factory: function MatBottomSheet_Factory() {
                return new MatBottomSheet(core.inject(overlay.Overlay), core.inject(core.INJECTOR), core.inject(MatBottomSheet, 12), core.inject(common.Location, 8), core.inject(MAT_BOTTOM_SHEET_DEFAULT_OPTIONS, 8));
            }, token: MatBottomSheet, providedIn: MatBottomSheetModule
        });
