...
}(this, (function (exports, animations, a11y, bidi, coercion, collections, keycodes, overlay, scrolling, core, forms, core$1, formField, rxjs, operators, common) {
    'use strict';
    ...
    var MatSelect = /** @class */ (function (_super) {
        ...
        function MatSelect(_viewportRuler, _changeDetectorRef, _ngZone, _defaultErrorStateMatcher, elementRef, _dir, _parentForm, _parentFormGroup, _parentFormField, ngControl, tabIndex, scrollStrategyFactory) {
            ...
            _this.optionSelectionChanges = rxjs.defer(function () {
                if (_this.options) {
                    return rxjs.merge.apply(void 0, _this.options.map(function (option) {
             ...
             */
            _this._openedStream = _this.openedChange.pipe(operators.filter(function (o) {
                return o;
             ...
             */
            _this._closedStream = _this.openedChange.pipe(operators.filter(function (o) {
                return !o;
            }), operators.map(function () {
            }));
            /**
        ...
        function (event) {
            ...
            if (keyCode === keycodes.HOME || keyCode === keycodes.END) {
                ...
                event.preventDefault();
                /** @type {?} */
                var hasDeselectedOptions_1 = this.options.some(function (opt) {
        ...
        function () {
            ...
            rxjs.merge.apply(void 0, this.options.map(function (option) {
