...
@mixin cdk-text-field-autofill-color($background, $foreground:'') {
  ...
  $cdk-text-field-autofill-color-frame-count: $cdk-text-field-autofill-color-frame-count + 1 !global;
}
...
$mat-tooltip-handset-vertical-padding: ($mat-tooltip-handset-target-height - $mat-tooltip-handset-font-size) / 2;
...
@mixin _mat-form-field-fill-label-floating($font-scale, $infix-padding, $infix-margin-top) {
  transform: translateY(-$infix-margin-top - $infix-padding + $mat-form-field-fill-dedupe) scale($font-scale);
...
@mixin _mat-form-field-legacy-label-floating($font-scale, $infix-padding, $infix-margin-top) {
  ...
  // translateZ fixes.
  transform: translateY(-$infix-margin-top - $infix-padding) scale($font-scale) perspective(100px) translateZ(0.001px + $mat-form-field-legacy-dedupe);
