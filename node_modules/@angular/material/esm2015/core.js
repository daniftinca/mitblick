...
constructor()
{
    ...
    super(._notifySubscriber(subscriber);
}
else
{
...
/** @nocollapse */ ErrorStateMatcher.ngInjectableDef = defineInjectable({
...
class GestureConfig extends HammerGestureConfig {
    ...
    /** @type {?} */
    let
    recognizer = new ((/** @type {?} */ (base.constructor)))(options);
...
    inheritances
) {
    inheritances
...
export {
    ...
    NOV,
    DEC,
    MATERIAL_SANITY_CHECKS_FACTORY as ɵa1
};
