...
class MatBottomSheetRef {
    ...
    .
        ...
        if (!containerInstance.bottomSheetConfig.disableClose) {
            merge(_overlayRef.backdropClick(), _overlayRef.keydownEvents().pipe(filter(event = > event.keyCode === ESCAPE))
        ).
    ...
    dismiss(result) {
        if (!this._afterDismissed.closed) {
            ...
            this.containerInstance._animationStateChanged.pipe(filter(event = > event.phaseName === 'start'), take(1)
        ).
...
[
    ...
    {
        type: MatBottomSheetConfig,
        decorators: [{type: Optional}, {type: Inject, args: [MAT_BOTTOM_SHEET_DEFAULT_OPTIONS,]}]
    }
];
/** @nocollapse */ MatBottomSheet.ngInjectableDef = defineInjectable({
